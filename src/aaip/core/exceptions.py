...
class AAIPError(Exception):
    ...
    def __init__(self, code: AAIPErrorCode, message: str, details: Optional[Dict[str, Any]] = None):
        """
...
def invalid_delegation_error(message: str, details: Optional[Dict[str, Any]] = None) -> DelegationError:
...
def signature_invalid_error(message: str = "Signature verification failed") -> SignatureError:
...
def scope_insufficient_error(required_scope: str, available_scopes: list) -> AuthorizationError:
