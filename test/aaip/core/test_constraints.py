...
class TestConstraintValidation:
    ...
    def test_max_amount_constraint(self):
        ...
        constraints = {
            "max_amount": {"value": 100.0, "currency": "USD"}
        }
    ...
    def test_time_window_constraint(self):
        ...
        start_time = datetime.fromtimestamp(now.timestamp() - 1800, tz=timezone.utc)  # 30 min ago
        future_time = datetime.fromtimestamp(now.timestamp() + 3600, tz=timezone.utc)  # 1 hour from now
...
class TestBlockedKeywordsConstraint:
    ...
    def test_blocked_keywords_constraint(self):
        ...
        case_insensitive_request = {
            "content": "Limited Time offer available now!"
        }
