...
class TestConstraintValidation:
    ...
    def test_time_window_constraint(self):
        ...
        start_time = datetime.fromtimestamp(now.timestamp() - 1800, tz=timezone.utc)
        future_time = datetime.fromtimestamp(now.timestamp() + 3600, tz=timezone.utc)
        ...
        past_constraints = {
            "time_window": {
                "start": start_time.isoformat().replace("+00:00", "Z"),
                "end": start_time.isoformat().replace("+00:00", "Z"),
            }
        }
